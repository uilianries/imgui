...
| D          | **BindBC-ImGui**: Static & dynamic bindings to Dear ImGui, compatible with BetterC, @nogc, and nothrow.<br>https://github.com/BindBC/bindbc-imgui<br>**DerelictImgui**: Dynamic bindings to cimgui for the D programming language <br>https://github.com/Extrawurst/DerelictImgui |
...
| Zig | **zig-gamedev/zgui**: Easy to use dear imgui bindings (includes ImPlot) <br> https://github.com/michal-z/zig-gamedev/blob/main/libs/zgui <br> **Zig-ImGui**: Zig bindings for ocornut/imgui, generated using cimgui/cimgui <br> https://github.com/SpexGuy/Zig-ImGui
